...
search.addEventListener("click", function () {
    ...
    chrome.runtime.sendMessage({ message: "start", count: count.value, mobile: mobile.value, minDelay: minDelay.value, maxDelay: maxDelay.value, amazonLink: amazonSelector.checked, closeTab: closeTabSelector.checked }, function (response) {
