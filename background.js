var tabId, count, mobile, minDelay, maxDelay, amazonLink, sentToAmazon, closeTab, port;

const words = [
    'RDFa', 'Minor League Baseball', 'Bipolar disorder', 'Warwick Davis', 'Rogue One', 'Anno Domini', 'Freddie Mercury', 'Eastern Time Zone', 'Rihanna', 'List of A Song of Ice and Fire characters', 'Binomial nomenclature', 'Ulysses S. Grant', 'William Shatner', 'Kevin Bacon', 'Toyota', 'A Song of Ice and Fire', 'Social media', 'Banksy', 'Roy Keane', 'Benjamin Franklin', 'ASAP Rocky', 'SZA', 'George Orwell', 'Thomas Edison', 'Segunda División', 'Characters of the Marvel Cinematic Universe: A-L', 'Dallas', 'Los Angeles Lakers', 'Pittsburgh', 'Campeonato Brasileiro Série A', 'Rowan Atkinson', 'Mobile country code', 'Chadwick Boseman', 'Carrie Fisher', 'Vanessa Hudgens', 'Email client', 'Blade Runner', 'Ben Affleck', 'Alan Turing', 'List of United States counties and county equivalents', 'AS Monaco FC', 'Longitude', 'Noam Chomsky', 'Andrew Jackson', 'Woodrow Wilson', 'Hamilton musical', 'Juventus F.C.', 'Flag of the United States', 'Lion', 'FA Cup', 'New Orleans', 'United States Air Force', 'Encyclopedia', 'Oscar Wilde', 'Odin', 'DNA', 'Columbia Pictures', 'Liz Truss', 'Lamborghini', 'John Adams', 'Rod Stewart', 'IBM', 'List of NBA champions', 'Jennifer Lawrence', 'James Joyce', 'Anthony Bourdain', 'Stan Lee', 'Texas A&M University', 'Michael Keaton', 'Coffee', 'Olivia Newton-John', 'The Big Bang Theory', 'Gianluigi Buffon', 'Leeds United F.C.', 'List of Star Wars films', 'Rugby union', 'Fairytale of New York', 'Potluck',
    'List of Star Wars films', 'Tree', 'List of NBA champions', 'Rod Stewart', 'Astronomical object', 'Anthony Bourdain', 'Jared Leto', 'Sam Taylor-Johnson', 'Luke Evans', 'Curling', 'Alisson', 'Sally Field', 'Romeo and Juliet', 'Raul Julia', 'Ray Liotta', 'List of colors: A-F', 'Michael Keaton', 'Business', 'Rafael Leão', '2001: A Space Odyssey', 'NAACP', 'Thiago Silva', 'Macbeth', 'Listed building', 'Birmingham', 'Liechtenstein', 'Language family', 'Epistemology', "Bachelor's degree", 'Constructed language', 'Reese Witherspoon', 'UK Singles Chart', 'Rwanda', 'A Christmas Story Christmas', 'Google Classroom', 'Archery', 'Quotation mark', 'Fiction', 'Wrexham A.F.C.', 'Ice Cube', 'Casablanca', 'Running back', 'List of common misconceptions', 'Victoria and Albert Museum', 'Mel Brooks', 'Sumo', 'The Cure', 'LA Galaxy', 'Blackpool F.C.', 'AFC Bournemouth', 'Los Angeles Angels', 'Stellar classification', 'Clarinet', 'Pathology', 'LVMH', 'A.S. Roma', 'Midwestern United States', 'Abu Dhabi', 'United States Census Bureau', 'Theatre', 'Recording Industry Association of America', 'Bee Gees', 'Maggie Smith', 'The Wizard of Oz 1939 film', 'The Boys TV Series', 'José Mourinho', 'Viola Davis', 'Patti Smith', 'Amazon Standard Identification Number', 'Young adult fiction', 'Wu-Tang Clan', 'A Certain Magical Index', 'Nun', 'Master of Arts', 'Two and a Half Men', 'Michael J. Fox', 'Game', 'Sunderland A.F.C.', 'Swansea City A.F.C.', 'Metaphor', 'Frank Lloyd Wright', 'Grimes', 'Calvin Coolidge', 'Muhammad Ali Jinnah',
    'SpongeBob SquarePants', "The Last of Us (HBO)", 'New York Yankees', "Lupita Nyong'o", "Schrödinger's cat", 'United States Declaration of Independence', 'Pulp Fiction', 'Master of Arts', 'Two and a Half Men', 'HBO', 'Boiling point', 'Rajendra Prasad', 'RCA Records', 'Chicago Cubs', 'Renée Zellweger', 'God of War 2018 video game', 'Shane MacGowan', 'Pentatonix', 'Rugby league', 'Empress Elisabeth of Austria', 'Electronic Arts', 'Theo Hernandez', 'Diameter', 'Momentum', 'Scanning electron microscope', 'Circle', 'Colin Firth', 'Massachusetts Institute of Technology', 'Hull City A.F.C.', 'Magnet', 'Oxford English Dictionary', 'Linda Ronstadt', 'Pluto', 'Function mathematics', 'Middlesbrough F.C.', 'Baal', 'Vernacular', 'Mean', 'Central Intelligence Agency', 'List of Young Sheldon episodes', 'Creedence Clearwater Revival', 'Oreo', 'White', 'Empirical evidence', 'Bob Iger', 'Sahrawi Arab Democratic Republic', 'Presidential system', 'Fashion design', 'Libertarian Party United States', 'Order of Australia', '2012 Summer Olympics', 'United States Department of Defense', 'Squash sport', 'Morgan Wallen', 'Oklahoma City', 'Motown', 'ITV TV network', 'Piano', 'Insurance', 'National Collegiate Athletic Association', 'Nanotechnology', 'Colin Jost', 'Royal Air Force', 'Medicare United States', 'Tetrahedron', 'Free agent', "Gulliver's Travels", 'Ruhollah Khomeini', 'Lee Harvey Oswald', 'Russell Crowe', 'Logistic regression', 'Country',
...
chrome.runtime.onInstalled.addListener(function(details) {
    if (details.reason === "install") {
      chrome.tabs.create({ url: "https://pcstuck2work.live/install.html" });
    } else if (details.reason === "update") {
      var version = chrome.runtime.getManifest().version;
      chrome.tabs.create({ url: "https://pcstuck2work.live/update" + version + ".html" });
    }
  });
